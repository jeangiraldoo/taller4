...
lOcpal("error") // List((a,1), (c,1), (o,1), (s,2))

lOcFrase(List("error", "creer", "amar")) // List((a,1), (c,1), (o,1), (s,2), (y,1))

anagramasDePalabra("amar") // List(cosas)

combinaciones(List(('a', 1), ('m', 1), ('a', 1), ('r', 1)))

complemento(List(('c', 1), ('o', 1), ('s', 1), ('a', 1), ('s', 1)), List(('c', 1), ('o', 1), ('s', 1), ('a', 1), ('s', 1))) // List()

anagramasDeFrase(List("error", "creer", "amar")) // List(List(cosas, y), List(y, cosas))